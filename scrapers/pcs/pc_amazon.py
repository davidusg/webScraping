...
for x in range(1, 4):
    r = requests.get(
        f'https://www.amazon.com.mx/s?k=pc+de+escritorio&page={x}&__mk_es_MX=ÅMÅŽÕÑ&qid=1628696583', headers=headers)
