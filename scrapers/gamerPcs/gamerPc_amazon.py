...
for x in range(1, 5):
    r = requests.get(
        f'https://www.amazon.com.mx/s?k=PC+Gamer&i=electronics&page={x}&__mk_es_MX=ÅMÅŽÕÑ&qid=1628694914', headers=headers)
    ...
    for item in productList:
        ...
        try:
            ...
            pcList.append(gamerPc)
            pd.DataFrame(pcList).to_csv(
                "amazon-gamer-pc.csv", index=False)
